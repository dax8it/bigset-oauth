...
## BigSet instructional requirement

Future edits to this video package should teach the BigSet skill workflow, not just “type a prompt.” The instructional sequence is:

1. dataset idea/client context,
2. short discovery interview,
3. expected bounded BigSet prompt structure,
4. Hermes research + strict JSON,
5. BigSet-owned auth/state/writes/export,
6. client-ready delivery: BigSet link, CSV/XLSX, HTML/PDF report, optional SMTP email.

Do not drift into generic SaaS explainer language or imply the user must manually craft the perfect prompt.
